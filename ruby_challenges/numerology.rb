# ask user birthdate in MMDDYYYY
puts "What is your birthdate in MMDDYYYY format: "

# assign birdate to variable
user_birthdate = gets
...
case number
    ...
    when 9 
        ...
        puts "Your birth path number didn't land on a number between 1-9!"
    end
